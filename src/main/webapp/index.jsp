            ...
            <div class="container-fluid">
               <div class="row d_flex">
                  <div class=" col-md-2 col-sm-3">
                     <div class="logo">
                        <a href="index.jsp">Harvest <span>Hub</span></a>
                     </div>
                  </div>
                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a href="service.jsp">Products</a></li>
                                <li><a href="testimonail.jsp">Schemes</a></li>
            ...
            <div class="row d_flex">
               <div class="col-lg-6 col-md-12">
                  <div class="titlepage text_align_left">
                     ...
                     <p> This Agricultural products Rural Entrepreneurship Management System acts a bridge between the rural producers of agriculture products and the urban consumers of the product.By serving as an intermediary, this system is crucial in bridging the gap between rural producers of agricultural products and urban consumers of those same products. </p>
                  ...
                  <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           ...
                           <p>Fresh vegetables are harvested or picked when they are ripe and have not undergone significant processing or preservation. They are known for their crisp texture, vibrant colors, and nutrition.</p>
                        </div>
                     </div>
               ...
               <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           ...
                           <p>Agriculture products encompass a wide range of goods produced through farming practices, including crops, livestock, and dairy items. These products are the result of agricultural .</p>
                        </div>
                     </div>
                     <a class="read_more" href="services.html">Read More</a>
                  </div>
               ...
               <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           ...
                           <p>They are cultivated using sustainable farming practices, focusing on environmental conservation and providing consumers with food that is free from harmful chemicals.</p>
                        </div>
                     </div>
                     <a class="read_more" href="services.html">Read More</a>
                  </div>
                           ...
                           <div class="col-md-6">
                              <div class="custom">
                                 <div class="d_flex">
                                  ...
                                  <p>Farmer will access valuable information, resources, and tools that can help them manage their farms more effectively. </p>
         ...
         <div class="footer">
               ...
               <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                           <div class="hedingh3 text_align_left">
                              ...
                              <ul class="recent">
                                 <li><img src="images/resent.jpg" alt="#"/>Rice  </li>
                                 <li><img src="images/resent.jpg" alt="#"/> Brinjal </li>
                              </ul>
                           </div>
                        </div>
                         <div class="col-lg-3 col-md-6">
                           <div class="hedingh3  flot_right text_align_left">
                              ...
                              <ul class="top_infomation">
                                 ...
                                 <li><i class="fa fa-envelope" aria-hidden="true"></i>
                                    <a href="Javascript:void(0)">harvesthub@gmail.com</a>
                                 </li>
                              </ul>
                           </div>
                        </div>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row d_flex">
                     <div class="col-md-8">
                        <p>© Harvest Hub 2023 All Rights Reserved.  <a href="https://html.design/"> </a></p>
                     </div>
                     <div class="col-md-4">
